...
def get_top_stack_crates_with_multiple_crates(plan: Plan) -> str:
    starting_stacks, instructions = plan
    stacks = starting_stacks.copy()
    ...
    for crates_to_move, from_stack, to_stack in instructions:
        ...
        for crate in reversed(temporary_stack):
            stacks[to_stack].appendleft(crate)
...
def solution() -> None:
    ...
    print(get_top_stack_crates_with_multiple_crates(read_input("input.txt")))

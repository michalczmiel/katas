...
class StringCalculatorTestCase(unittest.TestCase):
    ...
    def test_ignores_numbers_bigger_than_1000(self):
    ...
    def test_returns_sum_if_multiple_delimiters_are_set(self):
        self.assertEqual(StringCalculator().add("//[*][%]\n1*2%3"), 6)

    def test_returns_sum_if_multiple_any_length_delimiters_are_set(self):
        self.assertEqual(StringCalculator().add("//[***][%%]\n1***2%%3"), 6)
